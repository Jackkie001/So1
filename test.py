...
#------------------------------------
                ...
                ki.sendText(msg.to,"Bot 1 มาครับ 􀜁􀅔􏿿")
                kk.sendText(msg.to,"Bot 2 มาครับ 􀜁􀅔􏿿")
                kc.sendText(msg.to,"Bot 3 มาครับ 􀜁􀅔􏿿")
                kd.sendText(msg.to,"Bot 4 􀜁􀅔􏿿 มาครับ")
                ke.sendText(msg.to,"Bot 5 􀜁 มาครับ")
                kf.sendText(msg.to,"Bot 6 􀜁􀅔􏿿 มาครับ")
                kg.sendText(msg.to,"Bot 7 􀜁􀅔􏿿 มาครับ")
                kh.sendText(msg.to,"Bot 8 􀜁มาครับ")
                kj.sendText(msg.to,"Bot 9 􀜁􀅔􏿿 มาครับ")
#------------------------------------
...
""")
            ...
            elif msg.text in ["S!!ett","Setti!!ng"]:
                print "Setting pick up..."
...
#                else:md+=" �� Mimic : off\n"
            ...
            elif msg.text in ["S!!et","Ma!n set"]:
                print "Setting pick up..."
